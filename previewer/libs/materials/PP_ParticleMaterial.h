...
#ifndef SPLOTCH_PREVIEWER_LIBS_MATERIALS_IMATERIAL_PP_PARTICLE_MATERIAL
#define SPLOTCH_PREVIEWER_LIBS_MATERIALS_IMATERIAL_PP_PARTICLE_MATERIAL
...
namespace previewer
{
	...
	class PP_ParticleMaterial : public IMaterial
	{
	public:
		void Bind();
